...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\DemoValidationController' => 'getDemoValidationControllerService',
            'App\\Controller\\FindLocationController' => 'getFindLocationControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/nelmio/security-bundle/src/EventListener/ExternalRedirectListener.php';
            include_once \dirname(__DIR__, 4).'/vendor/nelmio/security-bundle/src/ExternalRedirect/TargetValidator.php';
            include_once \dirname(__DIR__, 4).'/vendor/nelmio/security-bundle/src/ExternalRedirect/AllowListBasedTargetValidator.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'nelmio_security.external_redirect_listener', class: 'Nelmio\\SecurityBundle\\EventListener\\ExternalRedirectListener')] fn () => ($container->privates['nelmio_security.external_redirect_listener'] ?? self::getNelmioSecurity_ExternalRedirectListenerService($container)), 'onKernelResponse'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AuthController', 'App\\Controller\\DemoValidationController', 'App\\Controller\\FindLocationController', 'App\\Controller\\HealthCheckController', 'App\\Controller\\TransactionController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        return $container->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\TransactionVoter'] ?? $container->load('getTransactionVoterService'));
    ...
    /**
     * Gets the private 'monolog.formatter.line.stacktraces' shared service.
     *
     * @return \Monolog\Formatter\LineFormatter
     */
    protected static function getMonolog_Formatter_Line_StacktracesService($container)
    {
        $container->privates['monolog.formatter.line.stacktraces'] = $instance = new \Monolog\Formatter\LineFormatter();

        $instance->includeStacktraces();
    ...
    protected static function getMonolog_Handler_MainService($container)
    {
        ...
        $instance->setFormatter(($container->privates['monolog.formatter.line.stacktraces'] ?? self::getMonolog_Formatter_Line_StacktracesService($container)));
    ...
    {
        $container->privates['monolog.handler.stdout'] = $instance = new \Monolog\Handler\StreamHandler('php://stdout', 'debug', true, NULL, false);
     ...
     */
    protected static function getNelmioSecurity_ExternalRedirectListenerService($container)
    {
        return $container->privates['nelmio_security.external_redirect_listener'] = new \Nelmio\SecurityBundle\EventListener\ExternalRedirectListener(true, NULL, NULL, new \Nelmio\SecurityBundle\ExternalRedirect\AllowListBasedTargetValidator(NULL), ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)), ($container->services['router'] ?? self::getRouterService($container)));
    }
    ...
    {
        return $container->privates['router.request_context'] = \Symfony\Component\Routing\RequestContext::fromUri($container->getEnv('APP_URL'), 'localhost', 'http', 80, 443);
    }
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Validator\\SiretValidator' => ['privates', 'App\\Validator\\SiretValidator', 'getSiretValidatorService', true],
    ...
    private $loadedDynamicParameters = [
        ...
        'app.mail.host' => false,
        'app.url.base' => false,
        'app.url.webapp' => false,
        'app.url.webapp.loginform' => false,
        'app.url.api.prefix' => false,
        'app.url.api' => false,
        'app.sso.serviceprovider.x509cert' => false,
        'app.sso.serviceprovider.privateKey' => false,
        'app.sso.identityprovider.x509cert' => false,
        'app.sso.identityprovider.entityId' => false,
        'app.sso.identityprovider.loginurl' => false,
        'app.sso.identityprovider.logouturl' => false,
        'app.sso.configuration' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'app.mail.host' => $container->getEnv('MAIL_HOST'),
            'app.url.base' => $container->getEnv('APP_URL'),
            'app.url.webapp' => $container->getEnv('APP_URL'),
            'app.url.webapp.loginform' => $container->getEnv('string:APP_URL').'/auth/login',
            'app.url.api.prefix' => $container->getEnv('string:API_PREFIX').'/1.0',
            'app.url.api' => $container->getEnv('string:APP_URL').'/'.$container->getEnv('string:API_PREFIX').'/1.0',
            'app.sso.serviceprovider.x509cert' => $container->getEnv('APP_SSO_SERVICEPROVIDER_X509CERT'),
            'app.sso.serviceprovider.privateKey' => $container->getEnv('APP_SSO_SERVICEPROVIDER_PRIVATEKEY'),
            'app.sso.identityprovider.x509cert' => $container->getEnv('APP_SSO_IDENTITYPROVIDER_X509CERT'),
            'app.sso.identityprovider.entityId' => $container->getEnv('APP_SSO_IDENTITYPROVIDER_ENTITYID'),
            'app.sso.identityprovider.loginurl' => $container->getEnv('APP_SSO_IDENTITYPROVIDER_LOGINURL'),
            'app.sso.identityprovider.logouturl' => $container->getEnv('APP_SSO_IDENTITYPROVIDER_LOGOUTURL'),
            'app.sso.configuration' => [
                'strict' => true,
                'debug' => true,
                'sp' => [
                    'entityId' => $container->getEnv('APP_URL'),
                    'assertionConsumerService' => [
                        'url' => $container->getEnv('string:APP_URL').'/'.$container->getEnv('string:API_PREFIX').'/1.0/auth/sso/saml2/login',
                    ],
                    'singleLogoutService' => [
                        'url' => $container->getEnv('string:APP_URL').'/'.$container->getEnv('string:API_PREFIX').'/1.0/auth/sso/saml2/logout',
                    ],
                    'NameIDFormat' => 'urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress',
                    'x509cert' => $container->getEnv('APP_SSO_SERVICEPROVIDER_X509CERT'),
                    'privateKey' => $container->getEnv('APP_SSO_SERVICEPROVIDER_PRIVATEKEY'),
                ],
                'idp' => [
                    'entityId' => $container->getEnv('APP_SSO_IDENTITYPROVIDER_ENTITYID'),
                    'singleSignOnService' => [
                        'url' => $container->getEnv('APP_SSO_IDENTITYPROVIDER_LOGINURL'),
                    ],
                    'singleLogoutService' => [
                        'url' => $container->getEnv('APP_SSO_IDENTITYPROVIDER_LOGOUTURL'),
                    ],
                    'x509cert' => $container->getEnv('APP_SSO_IDENTITYPROVIDER_X509CERT'),
                ],
                'security' => [
            ...
            'google_maps_api_key' => $container->getEnv('GOOGLE_MAPS_API_KEY'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'security.role_hierarchy.roles' => [
                'ROLE_ADMIN' => [
                    0 => 'ROLE_RIGHT_ACCESS',
                    1 => 'ROLE_RIGHT_USER_READ',
                    2 => 'ROLE_RIGHT_USER_CREATE',
                    3 => 'ROLE_RIGHT_USER_DELETE',
                    4 => 'ROLE_RIGHT_USER_UPDATE',
                ],
                'ROLE_USER' => [
                    0 => 'ROLE_RIGHT_ACCESS',
                ],
            ...
            'nelmio_security.external_redirects.allow_list' => NULL,
